                    ...
                    <div class="bg-white/90 dark:bg-neutral-800/90 backdrop-blur-xl border border-white/40 dark:border-neutral-700 shadow-2xl rounded-3xl overflow-hidden"
                        ...
                        <div class="p-8">
                            ...
                            <div class="text-center mb-6">
                                ...
                                <h2 class="font-bold text-gray-900 dark:text-gray-100 mb-1 text-xl">Lupa Password?</h2>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Masukkan email Anda dan kami akan mengirimkan link reset password.</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="text-center mt-4">
                                    <a href="{{ route('login') }}" class="text-sm text-gray-500 dark:text-gray-400 hover:text-orange-500 dark:hover:text-orange-400 transition-colors">
