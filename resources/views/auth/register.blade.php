                    ...
                    <div class="bg-white/80 dark:bg-neutral-800/90 backdrop-blur-xl shadow-xl rounded-3xl overflow-hidden" data-aos="zoom-in"
                        ...
                        <div class="p-6 md:p-8">
                            ...
                            <div class="text-center mb-6">
                                <h2 class="font-bold text-gray-900 dark:text-gray-100 mb-1 text-xl">Buat Akun Baru</h2>
                                <p class="text-gray-500 dark:text-gray-400 text-sm">Bergabunglah dengan komunitas pecinta kuliner.</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('register') }}" class="mb-3" x-data="{ showPassword: false, showConfirmPassword: false }">
                                ...
                                <div class="relative mb-3">
                                    ...
                                    <label for="nameInput"
                                        class="absolute left-4 top-3 text-gray-500 dark:text-gray-400 text-sm transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-xs peer-[:not(:placeholder-shown)]:top-1 peer-[:not(:placeholder-shown)]:text-xs">Nama
                                        Lengkap</label>
                                </div>
                                <div class="relative mb-3">
                                ...
                                <div class="relative mb-4">
                                    ...
                                    <label for="passwordConfirmInput"
                                        class="absolute left-4 top-3 text-gray-500 dark:text-gray-400 text-sm transition-all peer-placeholder-shown:top-3 peer-placeholder-shown:text-base peer-focus:top-1 peer-focus:text-xs peer-[:not(:placeholder-shown)]:top-1 peer-[:not(:placeholder-shown)]:text-xs">Konfirmasi
                                        Kata Sandi</label>
                            ...
                            <div class="text-center">
                                <p class="text-gray-500 dark:text-gray-400 text-sm mb-0">Sudah punya akun?
                                    <a href="{{ route('login') }}"
