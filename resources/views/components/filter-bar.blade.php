    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:flex lg:items-center lg:gap-6 gap-3 mb-8 w-full">
        ...
        <div class="lg:flex-1 w-full text-left">
            ...
            <div class="relative group">
                ...
                <i class="bi bi-chevron-down absolute right-3 md:right-4 top-1/2 -translate-y-1/2 text-gray-400 text-xs pointer-events-none"></i>
            </div>
        </div>
        ...
        <div class="lg:flex-1 w-full text-left">
            ...
            <div class="relative group">
                ...
                <i class="bi bi-chevron-up absolute right-3 md:right-4 top-1/2 -translate-y-1/2 text-gray-400 text-xs pointer-events-none"></i>
            </div>
        </div>
