...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    <li class="nav-item">
                        <a class="nav-link fw-medium {{ request()->routeIs('recipes.index') ? 'active text-success' : '' }}"
                            href="{{ route('recipes.index') }}">Beranda</a>
                    </li>
                    @auth
                        <li class="nav-item ms-lg-3">
                            <div class="dropdown">
                                <button class="btn btn-outline-success dropdown-toggle rounded-pill px-4" type="button"
                    ...
                    @else
                        <li class="nav-item ms-lg-3">
                            <a href="{{ route('login') }}"
                                class="btn btn-link text-decoration-none text-secondary fw-medium me-2">Masuk</a>
                        </li>
                        <li class="nav-item">
    ...
    <footer class="bg-white border-top py-4 mt-auto">
        <div class="container text-center">
            <p class="text-secondary mb-0 small">&copy; {{ date('Y') }} Food Reviews. Dibuat dengan <span
                    class="text-danger">&hearts;</span> di Lombok.</p>
        </div>
    </footer>
