                                ...
                                <ul x-show="open" @click.outside="open = false"
                                    ...
                                    @if (Auth::user()->is_admin)
                                        ...
                                        <li>
                                            <a href="{{ route('admin.tags.index') }}"
                                                ...
                                                <span
                                                    class="bg-linear-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent">Kelola
                                                    Kategori</span>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <li class="mb-1">
                                        <a href="{{ route('profile.index') }}"
                                            ...
                                            <span
                                                class="bg-linear-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent">Profil
                                                Saya</span>
                                        </a>
                                    </li>
                                    <li>
